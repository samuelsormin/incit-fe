export default function Header() {
    return (
        <header className="fixed w-full left-0 bg-white flex justify-between items-center h-16 px-10 shadow z-10">
            ...
            <div className="flex-grow flex items-center">
                ...
                <input type="text" placeholder="Search anything here..." className="w-96 outline-0" />
            </div>
